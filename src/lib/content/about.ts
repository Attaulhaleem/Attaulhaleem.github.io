...
const aboutByLocale: Record<Locale, AboutContent> = {
	...
	ur: {
		title: 'میرا تعارف',
		description: 'تعارف، ٹایم لاین، اور وہ ٹولز جن کے ساتھ میں کام کرتا ہوں۔',
		paragraphs: [
			'السلام علیکم، میرا نام عطا ہے۔ آج کل میں پیرس، فرانس میں رہتا ہوں۔',
			'میں انسٹی ٹیوٹ پولی ٹیکنیک ڈی پیرس میں الیکٹریکل انجینیئرنگ کا طالب علم ہوں۔ میرا تخصص ڈیٹا اینالیٹکس اور پیٹرن ریکگنیشن ہے۔',
